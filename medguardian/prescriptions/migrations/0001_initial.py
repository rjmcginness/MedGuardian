...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('medications', '0002_remove_medication_manufacturer_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_time_taken', models.DateTimeField(default=datetime.datetime(2022, 7, 18, 3, 54, 51, 407915, tzinfo=utc), help_text='Date and time taken')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_prn', models.BooleanField(default=False, help_text='Is this an "as needed" medication')),
                ('prn_reason', models.CharField(help_text='Reason for "as needed" use', max_length=128)),
